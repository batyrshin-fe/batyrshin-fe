...
//вспомогательная функция - разлагает цвет на каналы
Void ColorMessage(System::Drawing::Color  _c){
...
//вспомогательная функция - позволяет просмотреть матрицу
Void MatrMessage(m8x8 matr){
	System::String ^str="";
...
Void Form1::Form1_Load(System::Object^  sender, System::EventArgs^  e) { 
	...
	for(int i=0;i<size_m;i++)
		for(int j=0;j<size_m;j++)
			A[i][j]=C_(i, size_m) * cos((2 * j + 1) * i * M_PI / 2 / size_m);	//MatrMessage(A);

	//транспонирование матрицы преобразований
	TransponMatrix(A,AT);														//MatrMessage(AT);

	//формирование фильтра
	//this->saveFileDialog1->Filter="BMP files|*.bmp|Все файлы|*.*";
...
Void Form1::buttonAbout_Click(System::Object^  sender, System::EventArgs^  e){	
	...
	MessageBox::Show( "Данное программное средство предназначено... \n\n Его разработал ...","Сообщение о разработчике Программного средства" );	
